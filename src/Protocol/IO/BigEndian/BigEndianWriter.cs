...
namespace Protocol.IO.BigEndian
{
    /// <summary>
    /// IO Pour Dofus 2.29
    /// </summary>
    public class BigEndianWriter : IDisposable
    {
        ...
        public byte[] Data
        {
            get
            {
                ...
                byte[] buffer = new byte[this.m_BinaryWriter.BaseStream.Length];
                this.m_BinaryWriter.BaseStream.Position = 0L;
                this.m_BinaryWriter.BaseStream.Read(buffer, 0, (int)this.m_BinaryWriter.BaseStream.Length);
                this.m_BinaryWriter.BaseStream.Position = position;
                return buffer;
            }
        }
        #endregion
        ...
        {
            get { return m_BinaryWriter.BaseStream.Position; }
            set
            {
             m_BinaryWriter.BaseStream.Position = value;
            }
        }
        ...
        {
            m_BinaryWriter.BaseStream.Seek(offset,SeekOrigin.Begin);
        }
