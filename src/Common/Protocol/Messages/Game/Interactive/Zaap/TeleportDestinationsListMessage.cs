...
namespace Common.Protocol.Network.Messages.Game.Interactive.Zaap
{
    ...
    public class TeleportDestinationsListMessage : NetworkMessage
    {
        ...
        public void Initiate(byte teleporterType, List<System.Int32> mapIds, List<System.UInt16> subAreaIds, List<System.UInt16> costs, List<System.Byte> destTeleporterType)
        {
