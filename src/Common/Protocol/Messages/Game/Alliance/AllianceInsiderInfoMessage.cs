...
namespace Common.Protocol.Network.Messages.Game.Alliance
{
    ...
    public class AllianceInsiderInfoMessage : NetworkMessage
    {
        ...
        public void Initiate(AllianceFactSheetInformations allianceInfos, List<GuildInsiderFactSheetInformations> guilds, List<PrismSubareaEmptyInfo> prisms)
        {
