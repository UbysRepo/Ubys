...
namespace Common.Protocol.Network.Types.Game.Context.Roleplay.Job
{
    ...
    public class JobCrafterDirectoryEntryPlayerInfo : NetworkType
    {
        ...
        public void Initiate(uint playerId, string playerName, byte alignmentSide, byte breed, bool sex, bool isInWorkshop, short worldX, short worldY, int mapId, ushort subAreaId, PlayerStatus status)
        {
            m_playerId = playerId;
