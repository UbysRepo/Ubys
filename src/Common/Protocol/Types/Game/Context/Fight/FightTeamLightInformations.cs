...
namespace Common.Protocol.Network.Types.Game.Context.Fight
{
    ...
    public class FightTeamLightInformations : AbstractFightTeamInformations
    {
        ...
        public void Initiate(bool hasFriend, bool hasGuildMember, bool hasAllianceMember, bool hasGroupMember, bool hasMyTaxCollector, byte teamMembersCount, uint meanLevel)
        {
